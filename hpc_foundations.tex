...
\begin{frame}{Common Parallel Patterns}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.5\textwidth}
			...
			\end{tikzpicture}
			\\[0.2em]
			\scriptsize 3 items in 4 steps (not 9)\\
...
\begin{frame}{Choosing Your Parallelization Strategy}
	...
	\begin{tikzpicture}[
		...
		result/.style={rectangle, draw, fill=green!20, text width=1.6cm, align=center, rounded corners, font=\tiny},
		example/.style={font=\tiny\itshape, text width=1.6cm, align=center},
