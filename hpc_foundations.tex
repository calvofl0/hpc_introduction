...
\begin{frame}{Choosing Your Parallelization Strategy}
	...
	\begin{tikzpicture}[
		...
		\draw[arrow] (indep) -- node[above left, font=\tiny] {Yes} (uniform);
		\draw[arrow] (indep) -- node[above right, font=\tiny] {No} (deptype);
...
\begin{frame}{Beyond Basic Patterns: Domain Strategies}
	\footnotesize
	\begin{columns}[T]
		\begin{column}{0.5\textwidth}
