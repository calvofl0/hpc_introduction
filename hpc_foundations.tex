    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.7]
                ...
                \draw[thick, fill=blue!20] (0,0.5) rectangle (4.8,1.3);
                \node at (2.4, 0.9) {Shared Memory};
                % Arrows
...
\begin{frame}{Compute Nodes in an HPC Cluster}
    ...
    \begin{tikzpicture}[scale=0.85]
        ...
        \draw[thick, fill=gray!5, rounded corners] (-0.3,2) rectangle (9.8,4.8);
        \node at (4.75, 4.5) {\textbf{SLURM Managed}};
        
        % Login node - at same level as compute nodes
        \draw[thick, fill=yellow!20, rounded corners] (0,2.3) rectangle (1.8,4);
        \node at (0.9, 3.5) {\small Login};
        \node at (0.9, 3.1) {\small Node};
        
        % Compute nodes
        \foreach \x in {2.3,4.3,6.3,8.3} {
            \draw[thick, fill=green!20, rounded corners] (\x,2.3) rectangle (\x+1.8,4);
            \node at (\x+0.9, 3.7) {\small Compute};
            \node at (\x+0.9, 3.4) {\small Node};
            \draw[thick, fill=blue!10] (\x+0.15,2.5) rectangle (\x+1.65,3.1);
            \node at (\x+0.9, 2.8) {\tiny Memory};
        }
        
        % Shared Storage - wider to match node width
        \draw[thick, fill=purple!20, rounded corners] (0,0) rectangle (10.1,1.2);
        \node at (5.05, 0.6) {Shared Storage};
        ...
        \node at (11.5, 3.15) {\small Users SSH};
        \draw[->, thick] (10.8, 3.15) -- (1.8, 3.15);
    \end{tikzpicture}
...
\begin{frame}{Why Parallel Computing?}
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \end{tikzpicture}
            \vskip0.3em
            {\small \textbf{Note:} Ideal speedup is rarely achieved due to overhead}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.75]
                ...
                \node[left] at (-0.3,1.75) {\tiny A[0:3]};
                \node[left] at (-0.3,1.5) {\tiny B[0:3]};
    ...
    c[i] = a[i] + b[i];
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.75]
                ...
                \draw[thick, rounded corners, fill=yellow!10] (0,0) rectangle (5.5,5.2);
                \node at (2.75, 4.85) {\textbf{Process}};
                
                % Threads - wider boxes
                \draw[thick, fill=green!20] (0.5,3) rectangle (1.7,4.5);
                \node at (1.1, 3.75) {\tiny Thread 1};
                
                \draw[thick, fill=green!20] (2.2,3) rectangle (3.4,4.5);
                \node at (2.8, 3.75) {\tiny Thread 2};
                
                \draw[thick, fill=green!20] (3.9,3) rectangle (5.1,4.5);
                \node at (4.5, 3.75) {\tiny Thread 3};
                
                % Shared memory
                \draw[thick, fill=blue!20] (0.5,0.5) rectangle (5.1,2.5);
                \node at (2.8, 1.5) {Shared Memory};
                
                % Arrows
                \draw[<->, thick] (1.1, 3) -- (1.1, 2.5);
                \draw[<->, thick] (2.8, 3) -- (2.8, 2.5);
                \draw[<->, thick] (4.5, 3) -- (4.5, 2.5);
            \end{tikzpicture}
            \vskip0.3em
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}[scale=0.72]
                % Node 1
                \draw[thick, rounded corners, fill=gray!10] (0,3) rectangle (3.8,5.7);
                \node at (1.9, 5.45) {\textbf{Node 1}};
                
                % MPI process 1 - more spacing
                \draw[thick, fill=yellow!20] (0.3,3.4) rectangle (3.5,5.15);
                \node at (1.9, 4.9) {\tiny MPI Process 0};
                
                % OpenMP threads - with proper spacing
                \foreach \x in {0.5,1.25,2.0,2.75} {
                    \draw[thick, fill=green!30] (\x,3.65) rectangle (\x+0.65,4.6);
                    \node at (\x+0.325, 4.125) {\tiny T};
                }
                
                % Node 2
                \draw[thick, rounded corners, fill=gray!10] (0,0) rectangle (3.8,2.7);
                \node at (1.9, 2.45) {\textbf{Node 2}};
                
                % MPI process 2 - more spacing
                \draw[thick, fill=yellow!20] (0.3,0.4) rectangle (3.5,2.15);
                \node at (1.9, 1.9) {\tiny MPI Process 1};
                
                % OpenMP threads - with proper spacing
                \foreach \x in {0.5,1.25,2.0,2.75} {
                    \draw[thick, fill=green!30] (\x,0.65) rectangle (\x+0.65,1.6);
                    \node at (\x+0.325, 1.125) {\tiny T};
                }
                
                % MPI communication
                \draw[<->, thick, red, dashed] (1.9, 3) -- (1.9, 2.7);
                \node at (4.3, 2.85) {\tiny MPI};
            \end{tikzpicture}
        \end{column}
    \end{columns}
    \vskip0.5em
...
\begin{frame}{Strong vs Weak Scaling}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \textbf{Example:}
            \begin{itemize}
                \item Process 1 GB data
                \item 1 core: 100 sec
                \item 4 cores: 30 sec (3.3× speedup)
                \item 16 cores: 10 sec (10× speedup)
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \textbf{Weak Scaling:}
            ...
            \textbf{Example:}
            \begin{itemize}
                \item 1 core: 1 GB in 100 sec
                \item 4 cores: 4 GB in 100 sec
                \item 16 cores: 16 GB in 100 sec
            \end{itemize}
        \end{column}
    \end{columns}
    \vskip0.5em
...
\begin{frame}{Amdahl's Law: The Speedup Limit}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \textbf{Key Insight:}
            \begin{itemize}
