...
\lstdefinelanguage{Julia}{
    morekeywords={function,if,else,elseif,end,for,while,return,using,import},
    sensitive=true,
    morecomment=[l]{\#},
    morestring=[b]",
    morestring=[b]',
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}[scale=0.75, every node/.style={scale=0.75}]
                ...
                \node at (1.5, 3.2) {\textbf{Socket 1}};
                
                % CPU 1
                \draw[thick, rounded corners, fill=blue!10] (0.2,0.2) rectangle (2.8,2.9);
                \node at (1.5, 2.6) {\textbf{CPU 1}};
                
                % Cores in Socket 1
                \draw[thick, fill=green!20] (0.4,1.5) rectangle (1.3,2.3);
                \node at (0.85, 1.9) {\tiny Core 0};
                
                \draw[thick, fill=green!20] (1.7,1.5) rectangle (2.6,2.3);
                \node at (2.15, 1.9) {\tiny Core 1};
                
                \draw[thick, fill=green!20] (0.4,0.4) rectangle (1.3,1.2);
                \node at (0.85, 0.8) {\tiny Core 2};
                
                \draw[thick, fill=green!20] (1.7,0.4) rectangle (2.6,1.2);
                \node at (2.15, 0.8) {\tiny Core 3};
                
                % Socket 2
                \draw[thick, rounded corners] (3.5,0) rectangle (6.5,3.5);
                \node at (5, 3.2) {\textbf{Socket 2}};
                
                % CPU 2
                \draw[thick, rounded corners, fill=blue!10] (3.7,0.2) rectangle (6.3,2.9);
                \node at (5, 2.6) {\textbf{CPU 2}};
                
                % Cores in Socket 2
                \draw[thick, fill=green!20] (3.9,1.5) rectangle (4.8,2.3);
                \node at (4.35, 1.9) {\tiny Core 0};
                
                \draw[thick, fill=green!20] (5.2,1.5) rectangle (6.1,2.3);
                \node at (5.65, 1.9) {\tiny Core 1};
                
                \draw[thick, fill=green!20] (3.9,0.4) rectangle (4.8,1.2);
                \node at (4.35, 0.8) {\tiny Core 2};
                
                \draw[thick, fill=green!20] (5.2,0.4) rectangle (6.1,1.2);
                \node at (5.65, 0.8) {\tiny Core 3};
            \end{tikzpicture}
        \end{column}
    \end{columns}
    \vskip1em
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.9]
                % Triangle representing hierarchy - taller version
                \draw[thick, fill=red!20] (0,0) -- (4,0) -- (2,7) -- cycle;
                
                % Labels - avoid top narrow part
                \node at (2, 1.2) {\small Storage};
                \node at (2, 2.5) {\small Disk};
                \node at (2, 3.5) {\small RAM};
                \node at (2, 4.8) {\tiny L3 Cache};
                \node at (2, 5.4) {\tiny L2 Cache};
                \node at (2, 5.9) {\tiny L1};
                
                % Speed arrow - bottom to top (slowest to fastest)
                \draw[->, thick] (4.8, 0.5) -- (4.8, 6.5) node[midway, right] {Speed};
                
                % Capacity arrow - outside triangle
                \draw[->, thick] (-0.5, -0.5) -- (4.5, -0.5) node[midway, below] {Capacity};
            \end{tikzpicture}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.7]
                ...
                \draw[thick, fill=blue!20] (0,0.5) rectangle (5.3,1.3);
                \node at (2.65, 0.9) {Shared Memory};
                % Arrows
                \foreach \x in {0.9,2.4,3.9} {
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.7]
                % Node 1
                \draw[thick, fill=green!20] (0.5,2.5) rectangle (1.3,3.3);
                \node at (0.9, 2.9) {\tiny Core};
                \draw[thick, fill=blue!20] (0.5,1.5) rectangle (1.3,2.3);
                \node at (0.9, 1.9) {\tiny Mem};
                
                % Node 2
                \draw[thick, fill=green!20] (2,2.5) rectangle (2.8,3.3);
                \node at (2.4, 2.9) {\tiny Core};
                \draw[thick, fill=blue!20] (2,1.5) rectangle (2.8,2.3);
                \node at (2.4, 1.9) {\tiny Mem};
                
                % Node 3
                \draw[thick, fill=green!20] (3.5,2.5) rectangle (4.3,3.3);
                \node at (3.9, 2.9) {\tiny Core};
                \draw[thick, fill=blue!20] (3.5,1.5) rectangle (4.3,2.3);
                \node at (3.9, 1.9) {\tiny Mem};
                
                % Network
                \draw[thick, <->, red] (1.3, 1.9) -- (2, 1.9);
                \draw[thick, <->, red] (2.8, 1.9) -- (3.5, 1.9);
                \node at (2.4, 1.1) {\small Network};
            \end{tikzpicture}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Compute Nodes in an HPC Cluster}
    \centering
    \begin{tikzpicture}[scale=0.85]
        % Big box for SLURM managed nodes
        \draw[thick, fill=gray!5, rounded corners] (-0.3,2) rectangle (10.1,4.8);
        \node at (4.9, 4.5) {\textbf{SLURM Managed}};
        
        % Login node - at same level as compute nodes
        \draw[thick, fill=yellow!20, rounded corners] (0,2.3) rectangle (1.8,4.2);
        \node at (0.9, 3.5) {\small Login};
        \node at (0.9, 3.1) {\small Node};
        
        % Compute nodes with more spacing
        \foreach \x in {2.3,4.3,6.3,8.3} {
            \draw[thick, fill=green!20, rounded corners] (\x,2.3) rectangle (\x+1.8,4.2);
            \node at (\x+0.9, 3.8) {\small Compute};
            \node at (\x+0.9, 3.45) {\small Node};
            \draw[thick, fill=blue!10] (\x+0.15,2.5) rectangle (\x+1.65,3.1);
            \node at (\x+0.9, 2.8) {\tiny Memory};
        }
        
        % Shared Storage - wider box
        \draw[thick, fill=purple!20, rounded corners] (-0.3,0) rectangle (10.1,1.2);
        \node at (4.9, 0.6) {Shared Storage};
        
        % Storage connections from all nodes
        \foreach \x in {0.9,3.2,5.2,7.2,9.2} {
            \draw[->, thick, dashed] (\x, 2.3) -- (\x, 1.2);
        }
        
        \node at (11.5, 3.25) {\small Users SSH};
        \draw[->, thick] (10.8, 3.25) -- (1.8, 3.25);
    \end{tikzpicture}
...
\begin{frame}{Understanding Resource Allocation}
    ...
    \begin{tikzpicture}[scale=0.85]
        % Title
        \node at (5, 6) {\textbf{Different Job Layouts on a Cluster}};
        
        % Single Node - Serial Job
        \node at (2, 5.2) {\small Serial Job};
        \draw[thick, fill=gray!20] (0.5,3.2) rectangle (3.5,4.7);
        \node at (2, 4.5) {\tiny Node 1};
        \draw[thick, fill=green!40] (0.7,3.4) rectangle (1.3,4.3);
        \node at (1, 3.85) {\tiny T};
        \foreach \x in {1.5,1.9,2.3,2.7,3.1} {
            \draw[thick, fill=gray!10] (\x,3.4) rectangle (\x+0.3,4.3);
        }
        
        % Multi-threaded Job
        \node at (6.5, 5.2) {\small Multi-threaded (OpenMP)};
        \draw[thick, fill=gray!20] (5,3.2) rectangle (8,4.7);
        \node at (6.5, 4.5) {\tiny Node 1};
        \foreach \x in {5.2,5.6,6.0,6.4,6.8,7.2,7.6} {
            \draw[thick, fill=green!40] (\x,3.4) rectangle (\x+0.3,4.3);
            \node at (\x+0.15, 3.85) {\tiny T};
        }
        
        % Distributed MPI Job
        \node at (2, 2.2) {\small Distributed (MPI)};
        \draw[thick, fill=gray!20] (0.5,0.2) rectangle (1.8,1.7);
        \node at (1.15, 1.5) {\tiny N1};
        \draw[thick, fill=blue!40] (0.6,0.3) rectangle (0.95,1.3);
        \node at (0.775, 0.8) {\tiny T};
        \draw[thick, fill=blue!40] (1.05,0.3) rectangle (1.4,1.3);
        \node at (1.225, 0.8) {\tiny T};
        \draw[thick, fill=blue!40] (1.45,0.3) rectangle (1.7,1.3);
        \node at (1.575, 0.8) {\tiny T};
        
        \draw[thick, fill=gray!20] (2.1,0.2) rectangle (2.9,1.7);
        \node at (2.5, 1.5) {\tiny N2};
        \draw[thick, fill=blue!40] (2.2,0.3) rectangle (2.55,1.3);
        \node at (2.375, 0.8) {\tiny T};
        \draw[thick, fill=blue!40] (2.65,0.3) rectangle (2.8,1.3);
        \node at (2.725, 0.8) {\tiny T};
        
        % Hybrid Job
        \node at (6.5, 2.2) {\small Hybrid (MPI + OpenMP)};
        \draw[thick, fill=gray!20] (5,0.2) rectangle (6.3,1.7);
        \node at (5.65, 1.5) {\tiny N1};
        \foreach \x in {5.1,5.5,5.9} {
            \draw[thick, fill=purple!40] (\x,0.3) rectangle (\x+0.3,1.3);
            \node at (\x+0.15, 0.8) {\tiny T};
        }
        
        \draw[thick, fill=gray!20] (6.6,0.2) rectangle (7.9,1.7);
        \node at (7.25, 1.5) {\tiny N2};
        ...
        \vskip0.8em
        \draw[thick, fill=green!40] (9.5,3.7) rectangle (9.8,4);
        \node at (10.5, 3.85) {\tiny Threads};
        \draw[thick, fill=blue!40] (9.5,3.2) rectangle (9.8,3.5);
        \node at (10.5, 3.35) {\tiny MPI tasks};
        \draw[thick, fill=purple!40] (9.5,2.7) rectangle (9.8,3);
        \node at (10.5, 2.85) {\tiny Hybrid};
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Why Parallel Computing?}
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \end{tikzpicture}
            \vskip0.3em
            {\footnotesize \textbf{Note:} Ideal speedup is rarely achieved due to overhead}
        \end{column}
    \end{columns}
\end{frame}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.75]
                ...
                \foreach \y/\n in {5/0,4.5/1,4/2,3.5/3} {
                    \node[left] at (-0.3,\y) {\tiny A[\n]};
                    \node[left] at (-0.3,\y-0.2) {\tiny B[\n]};
                    \draw[->, thick] (0,\y) -- (1,\y);
                    \draw[->, thick] (0,\y-0.2) -- (1,\y-0.2);
                ...
                \node[left] at (-0.3,2) {\tiny A[0:1]};
                \node[left] at (-0.3,1.5) {\tiny B[0:1]};
                \draw[->, thick, blue] (0,2) -- (1,2);
    ...
    c[i] = a[i] + b[i];
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.75]
                ...
                \draw[thick, rounded corners, fill=yellow!10] (0,0) rectangle (5.8,5.4);
                \node at (2.9, 5) {\textbf{Process}};
                
                % Threads - wider boxes
                \draw[thick, fill=green!20] (0.6,3.2) rectangle (2,4.6);
                \node at (1.3, 3.9) {\tiny Thread 1};
                
                \draw[thick, fill=green!20] (2.4,3.2) rectangle (3.8,4.6);
                \node at (3.1, 3.9) {\tiny Thread 2};
                
                \draw[thick, fill=green!20] (4.2,3.2) rectangle (5.6,4.6);
                \node at (4.9, 3.9) {\tiny Thread 3};
                
                % Shared memory
                \draw[thick, fill=blue!20] (0.6,0.6) rectangle (5.6,2.7);
                \node at (3.1, 1.65) {Shared Memory};
                
                % Arrows
                \draw[<->, thick] (1.3, 3.2) -- (1.3, 2.7);
                \draw[<->, thick] (3.1, 3.2) -- (3.1, 2.7);
                \draw[<->, thick] (4.9, 3.2) -- (4.9, 2.7);
            \end{tikzpicture}
            \vskip0.3em
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}[scale=0.72]
                % Node 1
                \draw[thick, rounded corners, fill=gray!10] (0,3.2) rectangle (4,5.9);
                \node at (2, 5.6) {\textbf{Node 1}};
                
                % MPI process 1 - more spacing
                \draw[thick, fill=yellow!20] (0.35,3.6) rectangle (3.65,5.3);
                \node at (2, 5.05) {\tiny MPI Process 0};
                
                % OpenMP threads - with proper spacing
                \foreach \x in {0.55,1.35,2.15,2.95} {
                    \draw[thick, fill=green!30] (\x,3.85) rectangle (\x+0.7,4.75);
                    \node at (\x+0.35, 4.3) {\tiny T};
                }
                
                % Node 2
                \draw[thick, rounded corners, fill=gray!10] (0,0) rectangle (4,2.7);
                \node at (2, 2.4) {\textbf{Node 2}};
                
                % MPI process 2 - more spacing
                \draw[thick, fill=yellow!20] (0.35,0.4) rectangle (3.65,2.1);
                \node at (2, 1.85) {\tiny MPI Process 1};
                
                % OpenMP threads - with proper spacing
                \foreach \x in {0.55,1.35,2.15,2.95} {
                    \draw[thick, fill=green!30] (\x,0.65) rectangle (\x+0.7,1.55);
                    \node at (\x+0.35, 1.1) {\tiny T};
                }
                
                % MPI communication
                \draw[<->, thick, red, dashed] (2, 3.2) -- (2, 2.7);
                \node at (4.5, 2.95) {\tiny MPI};
            \end{tikzpicture}
        \end{column>
    \end{columns}
    \vskip0.5em
...
\begin{frame}{Defining Speedup}
    \textbf{What is Speedup?}
    \vskip1em
    Speedup quantifies how much faster a parallel program runs compared to its serial version.
    \vskip1em
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            where:
            \begin{itemize}
                \item $S(n)$ = speedup using $n$ processors
                \item $T_1$ = execution time with 1 processor
                \item $T_n$ = execution time with $n$ processors
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \textbf{Types of Speedup:}
            \begin{itemize}
                \item \textbf{Linear}: $S(n) = n$
                \begin{itemize}
                    \item Ideal case
                    \item Doubling processors halves time
                \end{itemize}
                \item \textbf{Sub-linear}: $S(n) < n$
                \begin{itemize}
                    \item Most common
                    \item Due to overhead
                \end{itemize}
                \item \textbf{Super-linear}: $S(n) > n$
                \begin{itemize}
                    \item Rare
                    \item Cache effects
                \end{itemize}
...
\begin{frame}{Weak vs Strong Scaling}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \textbf{Strong Scaling:}
            \begin{itemize}
                \item \textbf{Definition:} Fixed total problem size, increase processors
                \item \textbf{Measure:} Time to solution
                \item \textbf{Goal:} Achieve linear speedup
            \end{itemize}
            \vskip1em
            \textbf{Formula:}
            \[
            ...
            \textbf{Reality:} Overhead limits scaling
        \end{column}
        \begin{column}{0.5\textwidth}
            \textbf{Weak Scaling:}
            \begin{itemize}
                \item \textbf{Definition:} Fixed problem size per processor
                \item \textbf{Measure:} Time remains constant
                \item \textbf{Goal:} Maintain efficiency
            \end{itemize}
            \vskip1em
            \textbf{Efficiency:}
            \[
            E(n) = \frac{T_1}{T_n \times n} \times 100\%
            \]
            \vskip1em
            \textbf{Ideal:} $E(n) = 100\%$
            
            \textbf{Reality:} Communication increases
        \end{column}
    \end{columns}
    \vskip1em
    \textbf{Which to use?} Strong scaling when problem size is fixed; weak scaling when you want to solve bigger problems.
\end{frame}

\begin{frame}{Deriving Amdahl's Law}
    \textbf{Intuition:} Not all code can be parallelized
    \vskip1em
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \textbf{Breaking Down Execution:}
            \begin{itemize}
                \item Serial portion: $T_s$ (cannot parallelize)
                \item Parallel portion: $T_p$ (can parallelize)
                \item Total time (serial): $T_1 = T_s + T_p$
            \end{itemize}
            \vskip1em
            \textbf{With $n$ processors:}
            \begin{itemize}
                \item Serial part: still $T_s$
                \item Parallel part: $\frac{T_p}{n}$ (ideal)
                \item Total: $T_n = T_s + \frac{T_p}{n}$
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            ...
            \textbf{As fraction $p = \frac{T_p}{T_1}$:}
            \[
            ...
            \textbf{Key Insight:}
            \begin{itemize}
                \item As $n \to \infty$: $S_{\max} = \frac{1}{1-p}$
                \item 10\% serial $\Rightarrow$ max 10× speedup
                \item 5\% serial $\Rightarrow$ max 20× speedup
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}{Understanding Speedup}
    \textbf{Speedup}: How much faster a parallel program runs compared to its serial version
    \vskip1em
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \textbf{Definition:}
            ...
            where:
            \begin{itemize}
                \item $T_{\text{serial}}$ = time with 1 processor
                \item $T_{\text{parallel}}$ = time with $n$ processors
            \end{itemize}
            \vskip1em
            \textbf{Ideal Speedup:}
            \begin{itemize}
                \item Linear: Speedup = $n$ processors
                \item Doubling processors halves time
                \item Rarely achieved in practice
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \textbf{Example:}
            \begin{itemize}
                ...
                \item Speedup = $\frac{100}{30} \approx 3.3\times$
            \end{itemize}
            \vskip1em
            \textbf{Efficiency:}
            \[
            ...
            \]
            \begin{itemize}
                \item In example: $\frac{3.3}{4} = 82.5\%$
                \item Goal: Keep efficiency $> 80\%$
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}{Strong vs Weak Scaling (Part 1)}
    \textbf{Strong Scaling:}
    \vskip1em
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \textbf{Concept:}
            \begin{itemize}
                \item Fixed total problem size
                \item Increase number of processors
                \item Measure time to solution
            \end{itemize}
            \vskip1em
            \textbf{Goal:} Solve same problem faster
            \vskip1em
            \textbf{Challenge:}
            \begin{itemize}
                \item Communication overhead increases
                \item Less work per processor
                \item Eventually becomes inefficient
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \textbf{Example:}
            \begin{itemize}
                \item Process 1 GB dataset
                \item 1 core: 100 seconds
                \item 4 cores: 30 seconds (3.3× speedup)
                \item 16 cores: 10 seconds (10× speedup)
                \item 64 cores: 8 seconds (12.5× speedup)
            \end{itemize}
            \vskip1em
            \textbf{Observation:}
            \begin{itemize}
                \item Diminishing returns
                \item Efficiency drops: 83\% → 62\% → 20\%
                \item Communication dominates
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}{Strong vs Weak Scaling (Part 2)}
    \textbf{Weak Scaling:}
    \vskip1em
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item Increase both processors and total size
            ...
            \textbf{Challenge:}
            \begin{itemize}
                \item Global communication may increase
                \item Synchronization overhead
                \item Load balancing complexities
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \textbf{Example:}
            \begin{itemize}
                \item 1 core: 1 GB in 100 seconds
                \item 4 cores: 4 GB in 102 seconds
                \item 16 cores: 16 GB in 105 seconds
                \item 64 cores: 64 GB in 110 seconds
            \end{itemize}
            \vskip1em
            \textbf{Observation:}
            \begin{itemize}
                \item Near-constant time
                \item Can solve much larger problems
                \item Better efficiency for large scales
            \end{itemize}
        \end{column}
    \end{columns}
    \vskip1em
    {\small \textbf{Key Difference:} Strong scaling fixes work, weak scaling fixes work per processor}
\end{frame}
...
\begin{frame}{Common SLURM Commands (Part 1)}
    {\footnotesize
...
\begin{frame}{Common SLURM Commands (Part 2)}
    {\footnotesize
...
\begin{frame}[fragile]{Example: Serial Job}
    {\small \textbf{Simplest case: Single core job}}
    \vskip0.5em
    \begin{lstlisting}[language=bash, basicstyle=\tiny\ttfamily]
#!/bin/bash
...
python my_serial_script.py
    \end{lstlisting}
    \vskip0.5em
    {\small \textbf{Resources:} 1 node, 1 core, 2 GB RAM, 30 minutes}
\end{frame}

\begin{frame}[fragile]{Example: Multi-threaded (OpenMP) Job}
    {\small \textbf{Using multiple cores on a single node}}
    \vskip0.5em
    \begin{lstlisting}[language=bash, basicstyle=\tiny\ttfamily]
#!/bin/bash
...
./my_openmp_program
    \end{lstlisting}
    \vskip0.5em
    {\small \textbf{Resources:} 1 task, 16 cores for threading, 32 GB RAM}
\end{frame}

\begin{frame}[fragile]{Example: MPI Job (Distributed)}
    {\small \textbf{Multiple tasks across nodes}}
    \vskip0.5em
    \begin{lstlisting}[language=bash, basicstyle=\tiny\ttfamily]
#!/bin/bash
...
mpirun ./my_mpi_program
    \end{lstlisting}
    \vskip0.5em
    {\small \textbf{Resources:} 4 nodes, 64 MPI tasks (16 per node), 128 GB total RAM}
\end{frame}

\begin{frame}[fragile]{Example: Hybrid MPI + OpenMP Job}
    {\small \textbf{Combining distributed and shared memory parallelism}}
    \vskip0.5em
    \begin{lstlisting}[language=bash, basicstyle=\tiny\ttfamily]
#!/bin/bash
...
mpirun ./my_hybrid_program
    \end{lstlisting}
    \vskip0.5em
    {\small \textbf{Resources:} 4 nodes, 16 MPI tasks (4 per node), 8 threads per task = 128 cores total}
\end{frame}
...
\begin{frame}{Resource Allocation Strategies}
    ...
    \begin{tabular}{p{3.5cm}p{3cm}p{4cm}}
        ...
        Simple scripts, many independent runs \\
        \midrule
        \textbf{Multi-threaded} & 
        \texttt{--ntasks=1} \newline \texttt{--cpus-per-task=N} & 
        Shared memory code (OpenMP), single node sufficient \\
        \midrule
        \textbf{MPI} & 
        \texttt{--ntasks=N} \newline \texttt{--cpus-per-task=1} & 
        Large scale problems, distributed memory, multiple nodes \\
        \midrule
        \textbf{Hybrid} & 
        \texttt{--ntasks=M} \newline \texttt{--cpus-per-task=N} & 
        Very large problems, both paradigms, reduced MPI overhead \\
        \bottomrule
    \end{tabular}
    }
\end{frame}
...
\begin{frame}{Programming Languages and Parallel Computing}
    {\footnotesize
    \begin{tabular}{p{2.3cm}p{2.8cm}p{5.5cm}}
        \toprule
...
\begin{frame}{Common Pitfalls and Solutions (Part 1)}
    {\small
    \textbf{Job Management Issues:}
    \vskip0.5em
    \begin{tabular}{p{5cm}p{5.5cm}}
        \toprule
...
\begin{frame}{Common Pitfalls and Solutions (Part 2)}
    {\small
...
\begin{frame}{Common Pitfalls and Solutions (Part 3)}
    {\small
    ...
    \begin{itemize}
        ...
        \item Use \texttt{scontrol show job <jobid>} for detailed info
        \item Monitor resource usage with \texttt{sacct -j <jobid> --format=JobID,MaxRSS,Elapsed}
    \end{itemize}
    \vskip1em
    \textbf{Prevention:}
    \begin{itemize}
        \item Test with small data first
        \item Estimate resources accurately
        \item Use job dependencies for workflows
        \item Set appropriate time limits
    \end{itemize}
    }
\end{frame}
...
\begin{frame}{Best Practices Summary (Part 1)}
    {\small
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
...
\begin{frame}{Best Practices Summary (Part 2)}
    {\small
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
