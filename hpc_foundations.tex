...
\begin{frame}{Understanding Resource Allocation}
    ...
    \begin{tikzpicture}[scale=0.85]
        ...
        \draw[thick, fill=green!40] (9.5,3.8) rectangle (9.8,4.1);
        \node at (10.5, 3.95) {\tiny Threads};
        \draw[thick, fill=blue!40] (9.5,3.3) rectangle (9.8,3.6);
        \node at (10.5, 3.45) {\tiny MPI tasks};
        \draw[thick, fill=purple!40] (9.5,2.8) rectangle (9.8,3.1);
        \node at (10.5, 2.95) {\tiny Hybrid};
    \end{tikzpicture}
\end{frame}
