    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}[scale=0.8, every node/.style={scale=0.8}]
                % Socket 1
                \draw[thick, rounded corners] (0,0) rectangle (2.2,4);
                \node at (1.1, 3.7) {\textbf{Socket 1}};
                
                % CPU 1
                \draw[thick, rounded corners, fill=blue!10] (0.2,0.3) rectangle (2,3.4);
                \node at (1.1, 3.1) {\textbf{CPU}};
                
                % Cores for Socket 1
                \draw[thick, fill=green!20] (0.4,2.2) rectangle (1.8,2.9);
                \node at (1.1, 2.55) {\tiny Core 0};
                
                \draw[thick, fill=green!20] (0.4,1.5) rectangle (1.8,2.1);
                \node at (1.1, 1.8) {\tiny Core 1};
                
                \draw[thick, fill=green!20] (0.4,0.8) rectangle (1.8,1.4);
                \node at (1.1, 1.1) {\tiny Core 2};
                
                \draw[thick, fill=green!20] (0.4,0.4) rectangle (1.8,0.7);
                \node at (1.1, 0.55) {\tiny Core 3};
                
                % Socket 2
                \draw[thick, rounded corners] (2.8,0) rectangle (5,4);
                \node at (3.9, 3.7) {\textbf{Socket 2}};
                
                % CPU 2
                \draw[thick, rounded corners, fill=blue!10] (3,0.3) rectangle (4.8,3.4);
                \node at (3.9, 3.1) {\textbf{CPU}};
                
                % Cores for Socket 2
                \draw[thick, fill=green!20] (3.2,2.2) rectangle (4.6,2.9);
                \node at (3.9, 2.55) {\tiny Core 0};
                
                \draw[thick, fill=green!20] (3.2,1.5) rectangle (4.6,2.1);
                \node at (3.9, 1.8) {\tiny Core 1};
                
                \draw[thick, fill=green!20] (3.2,0.8) rectangle (4.6,1.4);
                \node at (3.9, 1.1) {\tiny Core 2};
                
                \draw[thick, fill=green!20] (3.2,0.4) rectangle (4.6,0.7);
                \node at (3.9, 0.55) {\tiny Core 3};
            \end{tikzpicture}
        \end{column}
    \end{columns}
    \vskip1em
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.8]
                ...
                \draw[thick, fill=red!20] (0,0) -- (4,0) -- (2,6) -- cycle;
                
                % Labels - with top part empty
                \node at (2, 4.8) {\tiny Registers};
                \node at (2, 4.1) {\tiny L1 Cache};
                \node at (2, 3.4) {\tiny L2 Cache};
                \node at (2, 2.7) {\tiny L3 Cache};
                \node at (2, 1.8) {\small RAM};
                \node at (2, 0.7) {\small Disk};
                
                % Arrows for speed (bottom to top) and capacity (outside)
                \draw[->, thick] (4.5, 0.5) -- (4.5, 5.5) node[midway, right] {Speed};
                \draw[->, thick] (-0.8, 0) -- (-0.8, 5) node[midway, left, rotate=90, anchor=south] {Capacity};
            \end{tikzpicture}
            \vskip1em
            \end{center}
        \end{column}
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.7]
                ...
                % Shared memory - made wider
                \draw[thick, fill=blue!20] (0,0.5) rectangle (4.3,1.3);
                \node at (2.15, 0.9) {Shared Memory};
                % Arrows
...
\begin{frame}{Compute Nodes in an HPC Cluster}
    ...
    \begin{tikzpicture}[scale=0.9]
        % SLURM managed box
        \draw[thick, dashed, rounded corners] (-0.5,1.8) rectangle (9,6.5);
        \node at (4.25, 6.2) {\textbf{SLURM managed}};
        
        % Login node - same level as SLURM
        ...
        \foreach \x in {0,2.5,5,7.5} {
            \draw[thick, fill=green!20, rounded corners] (\x,2.5) rectangle (\x+2,4.5);
            \node at (\x+1, 4.1) {\small Compute};
            \node at (\x+1, 3.7) {\small Node};
            \vskip0.3em
            \draw[thick, fill=blue!10] (\x+0.2,2.7) rectangle (\x+1.8,3.1);
            \node at (\x+1, 2.9) {\tiny Memory};
        }
        
        % Storage - wider
        \draw[thick, fill=purple!20, rounded corners] (1.5,0) rectangle (6.5,1.5);
        \node at (4, 0.75) {Shared Storage};
        
        % Arrows
        \draw[->, thick] (1, 5) -- (1, 4.5);
        \draw[->, thick] (4, 5) -- (4, 4.9);
        \draw[->, thick] (4, 4.9) -- (1, 4.5);
        \draw[->, thick] (4, 4.9) -- (3.5, 4.5);
        \draw[->, thick] (4, 4.9) -- (6, 4.5);
        \draw[->, thick] (4, 4.9) -- (8.5, 4.5);
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}[scale=0.8]
                ...
                \node[align=right] at (1.8, 0.9) {(2.5 min\\each)};
            ...
            \end{tikzpicture}
            \vskip0.5em
            {\small \textbf{Note:} Ideal speedup is rarely achieved due to overhead and serial portions}
        \end{column}
    \end{columns}
\end{frame}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.8]
                ...
                \foreach \y/\n in {5/0,4.5/1,4/2,3.5/3} {
                    \node[left] at (0, \y) {\tiny A[\n]};
                    \draw[->, thick] (0.3,\y) -- (1,\y);
                    \node[left] at (0, \y-0.2) {\tiny B[\n]};
                    \draw[->, thick] (0.3,\y-0.2) -- (1,\y-0.2);
                    \draw[thick, fill=blue!20] (1,\y-0.3) rectangle (2,\y+0.1);
                    \node at (1.5, \y-0.1) {\tiny +};
                    \draw[->, thick] (2,\y-0.1) -- (3,\y-0.1);
                    \node[right] at (3, \y-0.1) {\tiny C[\n]};
                }
                
                % SIMD
                \node at (2.5, 2.5) {\textbf{SIMD (Vector)}};
                \node[left] at (0, 2) {\tiny A[0:3]};
                \draw[->, thick, blue] (0.5,2) -- (1,2);
                \node[left] at (0, 1.5) {\tiny B[0:3]};
                \draw[->, thick, red] (0.5,1.5) -- (1,1.5);
                \draw[thick, fill=green!20] (1,1.3) rectangle (2,2.2);
                \node at (1.5, 1.75) {\small +};
                \draw[->, thick, purple] (2,1.75) -- (3,1.75);
                \node[right] at (3, 1.75) {\tiny C[0:3]};
            \end{tikzpicture}
            \end{center}
            \vskip0.5em
            \textbf{Modern CPUs:}
    ...
    c[i] = a[i] + b[i];
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[scale=0.75]
                % Process
                \draw[thick, rounded corners, fill=yellow!10] (0,0) rectangle (5,5.2);
                \node at (2.5, 4.9) {\textbf{Process}};
                \vskip0.3em
                
                % Threads - wider boxes
                \draw[thick, fill=green!20] (0.3,3.2) rectangle (1.8,4.5);
                \node at (1.05, 3.85) {\tiny Thread 1};
                
                \draw[thick, fill=green!20] (2,3.2) rectangle (3.2,4.5);
                \node at (2.6, 3.85) {\tiny Thread 2};
                
                \draw[thick, fill=green!20] (3.5,3.2) rectangle (4.7,4.5);
                \node at (4.1, 3.85) {\tiny Thread 3};
                
                \vskip0.3em
                
                % Shared memory
                \draw[thick, fill=blue!20] (0.5,0.5) rectangle (4.5,2.8);
                \node at (2.5, 1.65) {Shared Memory};
                
                % Arrows
                \draw[<->, thick] (1.05, 3.2) -- (1.05, 2.8);
                \draw[<->, thick] (2.6, 3.2) -- (2.6, 2.8);
                \draw[<->, thick] (4.1, 3.2) -- (4.1, 2.8);
            \end{tikzpicture}
            \end{center}
            \vskip0.5em
...
\begin{frame}{Hybrid Parallelization}
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}[scale=0.7]
                % Node 1
                \draw[thick, rounded corners, fill=gray!10] (0,3) rectangle (3.8,5.8);
                \node at (1.9, 5.5) {\textbf{Node 1}};
                \vskip0.2em
                
                % MPI process 1
                \draw[thick, fill=yellow!20] (0.3,3.5) rectangle (3.5,5.2);
                \node at (1.9, 4.95) {\tiny MPI Process 0};
                \vskip0.2em
                
                % OpenMP threads
                \foreach \x in {0.5,1.2,1.9,2.6} {
                    \draw[thick, fill=green!30] (\x,3.7) rectangle (\x+0.55,4.7);
                    \node at (\x+0.275, 4.2) {\tiny T};
                }
                
                % Node 2
                \draw[thick, rounded corners, fill=gray!10] (0,0) rectangle (3.8,2.8);
                \node at (1.9, 2.5) {\textbf{Node 2}};
                \vskip0.2em
                
                % MPI process 2
                \draw[thick, fill=yellow!20] (0.3,0.3) rectangle (3.5,2.2);
                \node at (1.9, 1.95) {\tiny MPI Process 1};
                \vskip0.2em
                
                % OpenMP threads
                \foreach \x in {0.5,1.2,1.9,2.6} {
                    \draw[thick, fill=green!30] (\x,0.5) rectangle (\x+0.55,1.7);
                    \node at (\x+0.275, 1.1) {\tiny T};
                }
                
                % MPI communication
                \draw[<->, thick, red, dashed] (1.9, 3) -- (1.9, 2.8);
                \node at (4.2, 2.9) {\tiny MPI};
            \end{tikzpicture}
        \end{column}
    \end{columns}
    \vskip0.5em
...
\begin{frame}{Defining Speedup}
    ...
    \vskip1em
    Speedup measures how much faster a parallel program runs compared to its serial version:
    \[
    \text{Speedup}(n) = \frac{T_{\text{serial}}}{T_{\text{parallel}}(n)}
    \]
    where:
    \begin{itemize}
        \item $T_{\text{serial}}$ = execution time with 1 processor
        \item $T_{\text{parallel}}(n)$ = execution time with $n$ processors
        \item $n$ = number of processors
    \end{itemize}
    \vskip1em
    \textbf{Examples:}
    \begin{itemize}
        \item If serial takes 100s and parallel with 4 cores takes 25s: Speedup = $100/25 = 4$× (ideal!)
        \item If serial takes 100s and parallel with 4 cores takes 40s: Speedup = $100/40 = 2.5$× (typical)
        \item Linear speedup: Speedup$(n) = n$ (ideal but rare in practice)
    \end{itemize}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item Goal: Reduce time to solution
                \item Each processor does less work
            \end{itemize}
            \vskip0.5em
            \textbf{Metric:} 
            \[
            ...
            \textbf{Example:}
            \begin{itemize}
                \item Problem: Process 1 million data points
                \item 1 core: 100 seconds
                \item 4 cores: 30 seconds → Speedup = 3.3×
                \item 16 cores: 10 seconds → Speedup = 10×
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \textbf{Weak Scaling:}
            \begin{itemize}
                ...
                \item Increase processors AND problem size
                \item Goal: Solve larger problems
                \item Each processor does same work
            \end{itemize}
            \vskip0.5em
            \textbf{Metric:} 
            \[
            \text{Efficiency}(n) = \frac{T(1)}{T(n)}
            \]
            \vskip0.5em
            \textbf{Example:}
            \begin{itemize}
                \item Problem per core: 250k data points
                \item 1 core (250k): 100 seconds
                \item 4 cores (1M): 105 seconds → Efficiency = 95\%
                \item 16 cores (4M): 115 seconds → Efficiency = 87\%
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Deriving Amdahl's Law}
    ...
    \vskip1em
    Consider a program with execution time $T$ split into two parts:
    \begin{itemize}
        \item Serial portion: fraction $(1-p)$ of total time → takes $(1-p) \cdot T$ time
        \item Parallel portion: fraction $p$ of total time → takes $p \cdot T$ time
    \end{itemize}
    \vskip1em
    \textbf{With $n$ processors:}
    \begin{itemize}
        \item Serial portion: still takes $(1-p) \cdot T$ (can't be parallelized)
        \item Parallel portion: now takes $\frac{p \cdot T}{n}$ (divided among $n$ processors)
    \end{itemize}
    \vskip1em
    \textbf{Total parallel time:}
    \[
    ...
    \textbf{Speedup:}
    \[
    S(n) = \frac{T}{T_{\text{parallel}}(n)} = \frac{T}{(1-p) \cdot T + \frac{p \cdot T}{n}} = \frac{1}{(1-p) + \frac{p}{n}}
    \]
\end{frame}
...
\begin{frame}[fragile]{Amdahl's Law: The Speedup Limit}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \textbf{Examples:}
            \begin{itemize}
                \item 95\% parallel → max speedup = 20×
                \item 90\% parallel → max speedup = 10×
                \item 75\% parallel → max speedup = 4×
                \item 50\% parallel → max speedup = 2×
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}[scale=0.8]
...
\begin{frame}{Resource Allocation Strategies}
    ...
    \begin{tabular}{p{3cm}p{3.5cm}p{4.5cm}}
        ...
        Single-threaded code \newline Simple scripts \newline Many independent runs \\
        \midrule
        \textbf{Multi-threaded} & 
        \texttt{--ntasks=1} \newline \texttt{--cpus-per-task=N} & 
        OpenMP, threads \newline Shared memory code \newline Single node sufficient \\
        \midrule
        \textbf{MPI} & 
        \texttt{--ntasks=N} \newline \texttt{--cpus-per-task=1} & 
        Distributed memory \newline Large scale problems \newline Multiple nodes needed \\
        \midrule
        \textbf{Hybrid MPI+OpenMP} & 
        \texttt{--ntasks=M} \newline \texttt{--cpus-per-task=N} & 
        Both paradigms \newline Very large problems \newline Reduced MPI overhead \\
        \bottomrule
    \end{tabular}
\end{frame}
...
\begin{frame}{Programming Languages and Parallel Computing}
    \small
    \begin{tabular}{p{2cm}p{2.8cm}p{5.5cm}}
        \toprule
