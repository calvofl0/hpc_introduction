...
\begin{frame}{Course material and tools}
	\begin{itemize}
		\item \textbf{Interactive Pad}: \url{https://ood.dcsr.unil.ch/public/ipc-pad}
		\begin{itemize}
			\item Questions and Answers
			\item Pace (too fast, too slow)
			\item Feedback
		\end{itemize}
		\item \textbf{Open OnDemand}: \url{https://ood.dcsr.unil.ch/}
		\begin{itemize}
			\item Contains the Parallel HPC Course App
			\item Slides available in the App
			\item Hands-on in the App
		\end{itemize}
		\item \textbf{Quiz}: \url{https://fuiz.org/play}
	\end{itemize}
\end{frame}
